...
namespace billkill.payment.service.Infrastructure.Repository
{
    public class BaseRepository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        private readonly BillKillDbContext _dbContext;
        private readonly DbSet<TEntity> _entity;

        public BaseRepository(BillKillDbContext context)
        {
            _dbContext = context;
